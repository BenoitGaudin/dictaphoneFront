    ...
    return (
        ...
        <div className="footer">
            ...
            <div className="text-footer">
                YOU CAN RECORD YOUR VOICE, MODIFY IT, SELECT WHAT YOU WANT TOO KEEP. YOU CAN ALSO SAVE YOU VOICE ON YOUR COMPUTER AND KEEP YOUR FILES ON THE SITE IN UNLIMITED NUMBER.
